            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="header-logo">
                        <h2><a href="/" class="font-weight-lighter logo" style="color: white;">UchiStore<!-- <img src="{{asset('dist/img/logo.png')}}" alt=""> --></a></h2>
                    </div>
                </div>
                <!-- /LOGO -->
                <!-- SEARCH BAR -->
                            ...
                            <div class="cart-dropdown">
                                <div class="cart-list">
                                    <div class="product-widget">
                                        <div class="product-img"><img src="{{asset('dist/img/product01.png')}}" alt=""></div>
